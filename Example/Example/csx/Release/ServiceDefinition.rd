...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Example" generation="1" functional="0" release="0" Id="042970b9-2189-4597-8423-2b6093d72bfd" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="ExampleGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="FTPServerWorker" generation="1" functional="0" release="0" software="E:\opensauce\ftp2azure\Example\Example\csx\Release\roles\FTPServerWorker" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="1792" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="22aab9bf-cf8f-4439-bece-223f678c3390" ref="Microsoft.RedDog.Contract\ServiceContract\ExampleContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="074027e0-93c4-4fcf-ad07-4916c108deb2" ref="Microsoft.RedDog.Contract\Interface\FTPServerWorker:FTP2Azure.Command@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Example/ExampleGroup/FTPServerWorker:FTP2Azure.Command" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="22edd173-eca7-4610-9aab-c3ad4ca642e6" ref="Microsoft.RedDog.Contract\Interface\FTPServerWorker:FTP2Azure.Passive@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Example/ExampleGroup/FTPServerWorker:FTP2Azure.Passive" />
          </inPort>
        </interfaceReference>
